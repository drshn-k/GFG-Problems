<h2><a href="https://practice.geeksforgeeks.org/problems/maximum-sum-lcm3025/1">Maximum Sum LCM</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a positive number n. You need to write a program to find the maximum sum of distinct numbers such that the LCM of all these numbers is equal to n.</span><br>
<br>
